CREATE TYPE "public"."card_condition" AS ENUM('near_mint', 'excellent', 'good', 'played', 'poor');--> statement-breakpoint
CREATE TYPE "public"."card_language" AS ENUM('en', 'fr', 'ja', 'de', 'it', 'es', 'pt', 'zh', 'ko');--> statement-breakpoint
CREATE TYPE "public"."currency" AS ENUM('EUR', 'USD');--> statement-breakpoint
CREATE TYPE "public"."dispute_status" AS ENUM('open', 'resolved_refund', 'resolved_release');--> statement-breakpoint
CREATE TYPE "public"."listing_status" AS ENUM('active', 'reserved', 'completed', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."listing_type" AS ENUM('sale', 'trade', 'wanted');--> statement-breakpoint
CREATE TYPE "public"."market" AS ENUM('eu', 'us');--> statement-breakpoint
CREATE TYPE "public"."offer_status" AS ENUM('pending', 'accepted', 'declined', 'countered', 'withdrawn');--> statement-breakpoint
CREATE TYPE "public"."transaction_status" AS ENUM('pending_payment', 'escrowed', 'meetup_scheduled', 'completed', 'disputed', 'refunded', 'cancelled');--> statement-breakpoint
CREATE TABLE "alerts" (
...
ALTER TABLE "alerts" ADD CONSTRAINT "alerts_card_id_cards_id_fk" FOREIGN KEY ("card_id") REFERENCES "public"."cards"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "alerts" ADD CONSTRAINT "alerts_sealed_product_id_sealed_products_id_fk" FOREIGN KEY ("sealed_product_id") REFERENCES "public"."sealed_products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "collection_items" ADD CONSTRAINT "collection_items_sealed_product_id_sealed_products_id_fk" FOREIGN KEY ("sealed_product_id") REFERENCES "public"."sealed_products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "listings" ADD CONSTRAINT "listings_sealed_product_id_sealed_products_id_fk" FOREIGN KEY ("sealed_product_id") REFERENCES "public"."sealed_products"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "price_history" ADD CONSTRAINT "price_history_sealed_product_id_sealed_products_id_fk" FOREIGN KEY ("sealed_product_id") REFERENCES "public"."sealed_products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "trade_validations" ADD CONSTRAINT "trade_validations_transaction_id_transactions_id_fk" FOREIGN KEY ("transaction_id") REFERENCES "public"."transactions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "trade_validations" ADD CONSTRAINT "trade_validations_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "alerts_user_idx" ON "alerts" USING btree ("user_id","active");--> statement-breakpoint
...
CREATE INDEX "listings_geo_idx" ON "listings" USING btree ("latitude","longitude");--> statement-breakpoint
CREATE INDEX "listings_card_idx" ON "listings" USING btree ("card_id","status");--> statement-breakpoint
CREATE INDEX "listings_seller_idx" ON "listings" USING btree ("seller_id");--> statement-breakpoint
CREATE INDEX "messages_conversation_idx" ON "messages" USING btree ("conversation_id","created_at");--> statement-breakpoint
CREATE INDEX "offers_listing_idx" ON "offers" USING btree ("listing_id","status");--> statement-breakpoint
CREATE INDEX "price_lookup_idx" ON "price_history" USING btree ("card_id","card_language","condition","is_foil","market","recorded_at");--> statement-breakpoint
CREATE INDEX "price_sealed_idx" ON "price_history" USING btree ("sealed_product_id","market","recorded_at");--> statement-breakpoint
CREATE INDEX "profiles_geo_idx" ON "profiles" USING btree ("latitude","longitude");--> statement-breakpoint
CREATE UNIQUE INDEX "reviews_tx_reviewer_uq" ON "reviews" USING btree ("transaction_id","reviewer_id");--> statement-breakpoint
CREATE UNIQUE INDEX "sealed_set_name_uq" ON "sealed_products" USING btree ("set_id","name");--> statement-breakpoint
CREATE UNIQUE INDEX "sets_game_code_uq" ON "sets" USING btree ("game_id","code");--> statement-breakpoint
CREATE UNIQUE INDEX "validation_tx_user_uq" ON "trade_validations" USING btree ("transaction_id","user_id");--> statement-breakpoint
